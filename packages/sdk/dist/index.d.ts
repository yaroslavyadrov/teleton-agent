...
interface TonSDK {
     ...
     * @throws {PluginSDKError} WALLET_NOT_INITIALIZED, INVALID_ADDRESS, OPERATION_FAILED
     */
    sendJetton(jettonAddress: string, to: string, amount: number, opts?: {
        comment?: string;
     ...
     * @throws {PluginSDKError} WALLET_NOT_INITIALIZED, INVALID_ADDRESS, OPERATION_FAILED
     */
    createJettonTransfer(jettonAddress: string, to: string, amount: number, opts?: {
        comment?: string;
...
interface TelegramSDK {
     ...
     * @throws {PluginSDKError} BRIDGE_NOT_CONNECTED, OPERATION_FAILED
     */
    editMessage(chatId: string, messageId: number, text: string, opts?: EditMessageOptions): Promise<number>;
    /**
     ...
     * @throws {PluginSDKError} BRIDGE_NOT_CONNECTED, OPERATION_FAILED
     */
    pinMessage(chatId: string, messageId: number, opts?: {
        silent?: boolean;
        unpin?: boolean;
    }): Promise<void>;
    /**
     ...
     * @throws {PluginSDKError} BRIDGE_NOT_CONNECTED, OPERATION_FAILED
     */
    sendFile(chatId: string, file: string | Buffer, opts?: MediaSendOptions & {
        fileName?: string;
    }): Promise<number>;
    /**
     ...
     * @throws {PluginSDKError} BRIDGE_NOT_CONNECTED, OPERATION_FAILED
     */
    createPoll(chatId: string, question: string, answers: string[], opts?: PollOptions): Promise<number | null>;
    /**
     ...
     * @throws {PluginSDKError} BRIDGE_NOT_CONNECTED, OPERATION_FAILED
     */
    sendGift(userId: number | string, giftId: string, opts?: {
        message?: string;
        anonymous?: boolean;
    }): Promise<void>;
    /**
     ...
     * @throws {PluginSDKError} BRIDGE_NOT_CONNECTED, OPERATION_FAILED
     */
    sendStory(mediaPath: string, opts?: {
        caption?: string;
    }): Promise<number | null>;
    /**
...
interface BotSDK {
    ...
    editInlineMessage(inlineMessageId: string, text: string, opts?: {
        keyboard?: ButtonDef[][];
        parseMode?: string;
    }): Promise<void>;
 ...
 * ```
 */
declare class PluginSDKError extends Error {
