          ...
          if (!lastNotify || (now - lastNotify.created_at) > 86400) {
            ...
            try {
              ...
              const notifyText = userLang === "ru"
                ? "В группах Echo работает только для подписчиков. Оформите подписку или купите один ответ:"
                : "Echo works in groups for subscribers only. Subscribe or buy a single answer:";
